...
public class ValueColumnName extends Value {
    ...
    protected ValueColumnName(String value) {
        this.value = value;
    }
    ...
    public boolean equals(Object other) {
        return other instanceof ValueColumnName
                && value.equals(((ValueColumnName) other).value);
    }

    @Override
    public int compareTypeSafe(Value o, CompareMode mode) {
        return mode.compareString(value, ((ValueColumnName) o).value, false);
    }
...
//        }
    ...
    public static Value get(String s, boolean treatEmptyStringsAsNull) {
        ...
        ValueColumnName obj = new ValueColumnName(StringUtils.cache(s));
